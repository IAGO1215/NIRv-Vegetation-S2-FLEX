...
def main():
    ...
    if len(os.listdir(s2._path_input)) !=0 :
        for index, row in df_FLEX.iterrows():
            ...
            list_valid_pixels_L1C.append(temp_ValidPixelsL1C)
            list_valid_pixels_L2A.append(temp_ValidPixelsL2A)
            list_valid_percentage_L1C.append(temp_ValidPixelsPercentageL1C)
            list_valid_percentage_L2A.append(temp_ValidPixelsPercentageL2A)
